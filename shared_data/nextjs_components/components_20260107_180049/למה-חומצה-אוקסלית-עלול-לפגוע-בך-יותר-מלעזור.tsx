...
// Article: למה חומצה אוקסלית עלול לפגוע בך יותר מלעזור
// Generated from Instagram post: https://www.instagram.com/p/DHYaQ5MMWNZ/

export const metadata: Metadata = {
  title: 'למה חומצה אוקסלית עלול לפגוע בך יותר מלעזור',
  description: 'למה חומצה אוקסלית עלול לפגוע בך יותר מלעזור | מדריך תזונה מקצועי לנשים עם ליפאדמה. טיפים מעשיים, מתכונים בריאים ומידע מבוסס מחקר מאביטל רוזן.',
  keywords: ['ויטמינים', 'דלקת', 'ליפאדמה', 'אוקסלט', 'בריאות נשים', 'המזון', 'נמצאת', 'נטורופתיה', 'מתכונים', 'תזונה בריאה'],
  openGraph: {
    title: 'למה חומצה אוקסלית עלול לפגוע בך יותר מלעזור',
    description: 'למה חומצה אוקסלית עלול לפגוע בך יותר מלעזור | מדריך תזונה מקצועי לנשים עם ליפאדמה. טיפים מעשיים, מתכונים בריאים ומידע מבוסס מחקר מאביטל רוזן.',
    type: 'article',
...
התסמינים שעלולים להופיע:־<strong>כאב</strong>־תחושה שמלווה אותך יום יום־<strong>דלקת</strong>־תחושה שמלווה אותך יום יום
...
<strong>תשתי מים עם מינרלים</strong>־כדי לפצות על מה שהגוף מאבד־־־<strong>רוצה מדריך מפורט עם כל הטיפים והמתכונים?</strong> הספר הדיגיטלי שלי מכיל הכל במקום אחד. [לפרטים על הספר](digital־guide)` }} />
      ...
      <footer className="mt-12 pt-8 border-t border-gray-200">
        <div className="bg-blue-50 rounded-lg p-6">
          ...
          <a 
            href="https://www.instagram.com/p/DHYaQ5MMWNZ/" 
            target="_blank" 
