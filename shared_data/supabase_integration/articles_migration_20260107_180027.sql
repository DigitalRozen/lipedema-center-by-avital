...
**רוצה ליווי אישי ומקצועי?** אני כאן כדי לעזור לך למצוא את הדרך הנכונה בשבילך. [לחצי כאן לייעוץ אישי](clinic)$$,
    ...
    '{"בדיקות","תסמינים","אביטל רוזן","טיפול רפואי","בריאות נשים","בריא","אבחון","מומחה","ליפאדמה","אליו"}',
    1,
    '3564205224647314415',
...
**רוצה את המוצרים המדויקים שאני ממליצה?** הכנתי בשבילך רשימה של המוצרים הכי איכותיים. [לרשימת המוצרים](products)$$,
    ...
    '{"ניתן","עיסוי","פיזיותרפיה","אביטל רוזן","מכשירי","בריאות נשים","נפיחות","מציעים","שיקום","לימפה"}',
    1,
    '3801283406567593370',
...
**רוצה מדריך מפורט עם כל הטיפים והמתכונים?** הספר הדיגיטלי שלי מכיל הכל במקום אחד. [לפרטים על הספר](digital-guide)$$,
    ...
    '{"אוקסלט","שלהם","בחיים","אביטל רוזן","דלקת","עיכול","בריאות נשים","מתכונים","תזונה בריאה","ויטמינים"}',
    1,
    '3688847223521781858',
...
**רוצה את המוצרים המדויקים שאני ממליצה?** הכנתי בשבילך רשימה של המוצרים הכי איכותיים. [לרשימת המוצרים](products)$$,
    ...
    '{"עיסוי","פיזיותרפיה","אביטל רוזן","בריאות נשים","נפיחות","שיקום","ביתיים","לימפה","זהירות","תנועה"}',
    1,
    '3756378655711565241',
...
**רוצה את המוצרים המדויקים שאני ממליצה?** הכנתי בשבילך רשימה של המוצרים הכי איכותיים. [לרשימת המוצרים](products)$$,
    ...
    '{"פשוט","עיסוי","פיזיותרפיה","אביטל רוזן","בריאות נשים","נפיחות","הבנתי","שיקום","לימפה","שנים"}',
    1,
    '3702690855559330175',
...
**רוצה מדריך מפורט עם כל הטיפים והמתכונים?** הספר הדיגיטלי שלי מכיל הכל במקום אחד. [לפרטים על הספר](digital-guide)$$,
    ...
    '{"אוקסלט","טחון","אביטל רוזן","דלקת","עיכול","קוקוס","חמאת","בריאות נשים","מתכונים","תזונה בריאה"}',
    1,
    '3711338892759975658',
...
**רוצה מדריך מפורט עם כל הטיפים והמתכונים?** הספר הדיגיטלי שלי מכיל הכל במקום אחד. [לפרטים על הספר](digital-guide)$$,
    ...
    '{"אוקסלט","סירופ","אונג","אביטל רוזן","דלקת","עיכול","בריאות נשים","מתכונים","מסורתי","תזונה בריאה"}',
    1,
    '3718543423650453804',
...
**רוצה ליווי אישי ומקצועי?** אני כאן כדי לעזור לך למצוא את הדרך הנכונה בשבילך. [לחצי כאן לייעוץ אישי](clinic)$$,
    ...
    '{"בדיקות","תסמינים","המידע","אביטל רוזן","בסרטן","טיפול רפואי","בריאות נשים","לפנות","האגודה","למלחמה"}',
    1,
    '3752015942302565675',
...
**רוצה מדריך מפורט עם כל הטיפים והמתכונים?** הספר הדיגיטלי שלי מכיל הכל במקום אחד. [לפרטים על הספר](digital-guide)$$,
    ...
    '{"אוקסלט","אביטל רוזן","דלקת","עיכול","בריאות נשים","אוקסלית","מתכונים","חומצה","תזונה בריאה","המזון"}',
    1,
    '3591736212956734297',
...
**רוצה מדריך מפורט עם כל הטיפים והמתכונים?** הספר הדיגיטלי שלי מכיל הכל במקום אחד. [לפרטים על הספר](digital-guide)$$,
    ...
    'Low Ticket (Digital Guide)',
    $$למה דלקת עלול לפגוע בך יותר מלעזור | מדריך תזונה מקצועי לנשים עם ליפאדמה. טיפים מעשיים, מתכונים בריאים ומידע מבוסס מחקר מאביטל רוזן.$$,
    '{"אוקסלט","לילדים","אביטל רוזן","דלקת","עיכול","קטנים","בריאות נשים","מנטה","מתכונים","תזונה בריאה"}',
    2,
    '3680162508371641586',
