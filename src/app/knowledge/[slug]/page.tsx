...
export default function PostPage() {
  ...
  const imageUrl = post?.image_url || 
    `${baseUrl}/api/og?title=${encodeURIComponent(post?.title || '')}&category=${encodeURIComponent(post?.category_display || post?.category || '')}&excerpt=${encodeURIComponent(pageDescription)}`
