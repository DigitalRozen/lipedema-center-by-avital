...
export const translations = {
  he: {
    ...
    features: {
      ...
      knowledge: {
        title: 'מרכז הידע',
        description: 'מאמרים מקצועיים, מחקרים עדכניים וטיפים מעשיים לניהול ליפדמה בחיי היומיום.',
      },
      treatments: {
    ...
    clinic: {
      ...
      description: 'טיפולים מתקדמים לליפדמה בסביבה מפנקת ומקצועית. הצטרפי לרשימת ההמתנה וקבלי גישה ראשונה.',
    ...
    footer: {
      expert: 'מומחית ליפדמה',
      description: 'מלווה נשים בדרך להבנה עמוקה של הגוף שלהן ולטיפול מותאם אישית בליפדמה. גישה הוליסטית המשלבת תזונה, טיפולים מתקדמים ותמיכה מקצועית.',
