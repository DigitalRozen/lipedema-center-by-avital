...
const updatedProducts = [
  {
    ...
    newData: {
      ...
      type: 'Physical',
      trigger_tags: ['לימפה', 'ניקוז לימפתי', 'נפיחות', 'עיסוי', 'חום', 'רטט', 'ליפדמה'],
      image_url: null,
      active: true
    }
  },
  {
    ...
    newData: {
      name: 'שרוול דחיסה רפואי לזרוע - ליפדמה ולימפדמה',
      description: 'שרוול דחיסה רפואי 15-20 mmHg לטיפול בליפדמה ולימפדמה. מספק תמיכה מדורגת מהיד עד הכתף, משפר זרימת דם ומפחית נפיחות',
      ...
      type: 'Physical',
      trigger_tags: ['דחיסה', 'שרוול', 'זרוע', 'ליפדמה', 'לימפדמה', 'נפיחות', 'זרימת דם'],
      image_url: null,
      active: true
    }
  },
  {
    ...
    newData: {
      name: 'גרבי דחיסה רפואיות לליפדמה',
      description: 'גרבי דחיסה רפואיות 20-30 mmHg מיוחדות לטיפול בליפדמה ולימפדמה ברגליים. עשויות מחומרים נושמים ומספקות תמיכה אופטימלית',
      ...
      type: 'Physical',
      trigger_tags: ['גרבי דחיסה', 'רגליים', 'ליפדמה', 'לימפדמה', 'דחיסה רפואית', 'נפיחות'],
      image_url: null,
      active: true
    }
  },
  {
    ...
    newData: {
      ...
      description: 'סט תחבושות דחיסה קצרות מיוחדות לטיפול בליפדמה ולימפדמה. כוללות תחבושות אלסטיות, רפידות וסרט לקיבוע - מערכת דחיסה רב-שכבתית',
      ...
      type: 'Physical',
      trigger_tags: ['תחבושות דחיסה', 'דחיסה רב-שכבתית', 'ליפדמה', 'לימפדמה', 'טיפול מקצועי'],
      image_url: null,
      active: true
    }
  }
...
const newProducts = [
  ...
  },
  {
    ...
    description: 'גרבי דחיסה רפואיות מיוחדות לליפדמה עם חומרים רכים לעור רגיש. המותג המוביל בעולם לטיפול בליפדמה ולימפדמה',
    price: 450, // מחיר משוער למוצר JOBST איכותי
    affiliate_link: 'https://amazon.com/s?k=JOBST+Elvarex+Soft&tag=1210080-20',
    type: 'Physical',
    trigger_tags: ['JOBST', 'גרבי דחיסה', 'עור רגיש', 'ליפדמה', 'לימפדמה', 'איכות פרימיום'],
    image_url: null,
    active: true
  },
  {
    name: 'Lympha Press Optimal Plus - מכשיר דחיסה פנאומטי',
    description: 'מכשיר דחיסה פנאומטי מתקדם לטיפול בליפדמה ולימפדמה. אושר FDA לטיפול בליפדמה בארה"ב',
    price: 12000, // מחיר משוער למכשיר מקצועי
    affiliate_link: 'https://amazon.com/s?k=Lympha+Press+Optimal+Plus&tag=1210080-20',
    type: 'Physical',
    trigger_tags: ['מכשיר דחיסה', 'פנאומטי', 'ליפדמה', 'לימפדמה', 'FDA', 'מקצועי'],
    image_url: null,
    active: true
  }
]
