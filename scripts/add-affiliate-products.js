...
const affiliateProducts = [
  ...
  },
  {
    ...
    description: 'מוצר מומלץ מאמזון לטיפול בליפדמה',
    ...
    type: 'Physical',
    trigger_tags: ['ליפדמה', 'טיפול', 'אמזון'],
    image_url: null,
    active: true
  },
  {
    name: 'מוצר אמזון 2 - B0F8NMRYKQ',
    description: 'מוצר נוסף מאמזון לטיפול בליפדמה',
    ...
    type: 'Physical',
    trigger_tags: ['ליפדמה', 'טיפול', 'אמזון', 'פיזי'],
    image_url: null,
    active: true
  },
  {
    name: 'מוצר אמזון 3 - B0FFH5GCP7',
    description: 'מוצר שלישי מאמזון לטיפול בליפדמה',
    ...
    type: 'Physical',
    trigger_tags: ['ליפדמה', 'טיפול', 'אמזון', 'שיקום'],
    image_url: null,
    active: true
  }
]
