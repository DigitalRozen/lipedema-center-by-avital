...
const premiumImageUpdates = [
  ...
  {
    productName: 'שרוול דחיסה רפואי לזרוע - ליפדמה ולימפדמה',
  ...
  {
    productName: 'גרבי דחיסה רפואיות לליפדמה',
  ...
  {
    productName: 'ספר דיגיטלי: מדריך התזונה לליפדמה',
  ...
  {
    productName: 'קורס וידאו: תרגילים לליפדמה',
